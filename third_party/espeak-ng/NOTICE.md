...
Blobby lazy-loads the `espeak-ng` npm package version 1.0.2 as its offline speech
...
The WebAssembly payload is delivered locally with the Blobby frontend and is not
